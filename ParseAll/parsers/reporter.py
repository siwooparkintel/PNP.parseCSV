...
def writeParsedInCSV(result_path, hobl_data, socwatch_targets, PCIe_targets, picks) :
    
    print(hobl_data)

    rap.reportAllPowerAndType2(result_path, hobl_data, socwatch_targets, PCIe_targets, picks)
