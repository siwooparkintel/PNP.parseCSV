...
SWP = [
    {
        "data_label":"Jothimani's Data",
        "power_summary_path":r".\test\20250801T171525-power-default_Raw_Summary.csv",
        "socwatch_summary_path":r".\test\20250801T171525-socwatch-default.csv"
    }
...
def main():
    ...
    rpt.writeParsedInCSV(result_csv, hobl_sets, picks, socwatch_targets, PCIe_targets)
